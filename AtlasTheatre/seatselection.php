...
<div class="col-lg-6">
	...
	if(isset($_POST['SubmitButton'])){
		...
		$sql = "SELECT seat.* from seat join reservation on seat.se_id=reservation.se_id WHERE reservation.s_id=".$_GET['s_id']." AND seat.se_no= :seat";
		$q = $pdo->prepare($sql);
		...
		if($booked){ 
			...
			<a href="./shoppingbasket.php?id=<?php echo  $_GET['s_id'] ?>&fk=<?php echo $_GET['m_id'] ?>&seat=<?php echo $seat?>"  style="font-size:20px; font-weight:500; color:#D11111">Add to my basket</a>&nbsp&nbsp&nbsp
			<a href="./shoppingbasket.php?id=<?php echo  $_GET['s_id'] ?>&fk=<?php echo $_GET['m_id'] ?>&seat=<?php echo $seat?>"><img src="./images/shopping_bag.png" width="35px" style="margin-top:-14px"></a><br><br>
		<?php }
	} ?>
